...
//Sauvegarde les instruments
    ...
    ui->spnBox_det_1->setValue((int) Table[24]);
    ui->spnBox_det_2->setValue((int) Table[25]);
    ui->spnBox_det_3->setValue((int) Table[26]);
    ui->spnBox_det_4->setValue((int) Table[27]);
...
//Sauvegarde les instruments
    ...
    Table[24] = (uchar) ui->spnBox_det_1->value();
    Table[25] = (uchar) ui->spnBox_det_2->value();
    Table[26] = (uchar) ui->spnBox_det_3->value();
    Table[27] = (uchar) ui->spnBox_det_4->value();
